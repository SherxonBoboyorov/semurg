            ...
            <div class="container">
                ...
                <div class="kacko__content">
                    <div class="kacko__info" data-aos="zoom-in">
                        <h3>Вид транспортного средства</h3>
                        <div class="types">
                        ...
                        <div class="line"></div>
                        <h3>Регион регистрации транспортного средства</h3>
                        <div class="types">
                            <div class="types__item">
                                <label>
                                    <input type="radio" name="kacko-el">
                                    <span>г.Ташкент и Ташкентская область</span>
                                </label>
                            </div>
                            <div class="types__item">
                                <label>
                        ...
                        <div class="types">
                            ...
                            <div class="types__item">
                                <label>
                                    <input type="radio" name="kacko-el">
                                    <span>Ограничено до 5 человек</span>
                                </label>
                            </div>
                        </div>
                    </div>
                    <div class="kacko__result" data-aos="fade-up">
                        ...
                        <ul class="res-list">
                            ...
                            <li class="res-list__item">
                                <p>Страховая сумма</p>
                                <h4>40 000 000 сум</h4>
                            </li>
                            <li class="res-list__item">
                                <p>Покрытие ущерба, причиненного жизни и здоровью потерпевшего</p>
                                <h4>65%</h4>
                            </li>
                            <li class="res-list__item">
                                <p>Покрытие ущерба, причиненного имуществу потерпевшего</p>
                                <h4>35%</h4>
                            </li>
                        </ul>
