    ...
    <main>
        ...
        <section class="kacko">
            <div class="container">
                <div class="kacko__top">
                    ...
                    <h1>@lang('front.calculate_the_cost_of_your_insurance_policy')</h1>
                </div>
                    ...
                    <div class="kacko__result" data-aos="fade-up" id="autoBrandSection" @if($brandId <= 0) style="display: none;" @endif>
                        ...
                        <ul class="res-list">
                            <li class="res-list__item" id="amountLiabilitySection" @if(!isset($_COOKIE['amountLiability'])) style="display: none;" @endif>
                                <p>@lang('front.amount_of_liability')</p>
                            ...
                            <li class="res-list__item" id="insurancePremiumSection" @if(!isset($_COOKIE['insurancePremium'])) style="display: none;" @endif>
                                <p>@lang('front.insurance_premium')</p>
                            ...
                            <li class="res-list__item" id="autoModelsSection" @if(!isset($_COOKIE['model_name'])) style="display: none;" @endif>
                                <p>@lang('front.automobile_model')</p>
                            ...
                            <li class="res-list__item" id="autoYearSection" @if(!isset($_COOKIE['kasko_year'])) style="display: none;" @endif>
                                <p>@lang('front.year_of_manufacture_of_the_car')</p>
                                <h4 id="autoYear">{{ $_COOKIE['kasko_year'] ?? "" }}</h4>
                            </li>
                        </ul>
                        <a href="{{ route('registerPolicy') }}" id="registrationPolicy" @if(!isset($_COOKIE['amountLiability']) && !isset($_COOKIE['insurancePremium'])) style="display: none" @endif class="btn form-btn btn-right">@lang('front.send_an_application_for_a_policy')</a>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="about-insurance">
            <div class="about-insurance__main">
                <div class="container">
                    @foreach (\App\Models\KackoBanner::orderBy('id')->take(1)->get() as $item)
            ...
            <div class="about-insurance__info">
                @foreach (\App\Models\KackoBanner::orderBy('id')->take(1)->get() as $content)
                <div class="container">
