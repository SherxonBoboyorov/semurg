                ...
                <div class="container">
                    ...
                    <ul class="nav__list">
                        <li class="res-nav-operation-li">
                            <a href="tel:1251" class="res-nav-operation">
        ...
        <div class="footer__info" data-aos="zoom-in">
            <div class="container">
                    ...
                    <ul class="footer__info__contact-list">
                        ...
                        <li>
                            <a href="#" class="loc">
                                ...
                                <span>г. Ташкент, Яшнабадский район, ул. Садыка Азимова, 50. 3 этаж.</span>
                            </a>
                        </li>
                        <li>
                            <a href="#">
                                ...
                                <span>info@semurgins.uz</span>
                            </a>
                        </li>
                    </ul>
                    <h4 class="heading4">Мы в социальных сетях:</h4>
                ...
                <div class="footer__info__information">
                    <h4 class="heading4">Информация</h4>
                    <ul>
                    ...
                    <p class="card-desc">Наши специалисты много лет плотно работают с мировым страховым рынком</p>
                </div>
            </div>
        </div>
        <div class="footer__bottom">
            <div class="container">
                <p class="desc2">Требование об обязательном указании ссылки на корпоративный веб-сайт общества при
                    использовании
                    другими лицами содержащихся в нем информационных материалов. Все документы, размещенные на этом
                    сайте являются электронными копиями оригиналов документов. При использовании информационных
                    материалов корпоративного сайта компании ссылка на корпоративный сайт обязательна!</p>
            </div>
        </div>
    </footer>
    <!-- to-Top-Btn -->
