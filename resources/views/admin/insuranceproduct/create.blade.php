            ...
            <div class="card">
                <div class="card-body">
                        <div class="row" style="margin-top: 15px">
                            <div class="col-md-3">
                                <label>Insurance Categories</label>
                                <select name="insurancecategory_id" id="insurancecategory_id" class="form-control">
                                    @foreach ($insurancecategories as $insurancecategory)
                                        <option value="{{ $insurancecategory->id }}">{{ $insurancecategory->title_en }}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="row" style="margin-top: 15px">
                            <div class="col-md-6">
                                ...
                                <textarea name="banner_text_ru" class="form-control" id="banner_text_ru" cols="30" rows="5"></textarea>
                            ...
                            <div class="col-md-6">
                                ...
                                <textarea name="banner_content_ru" class="form-control" id="banner_content_ru" cols="30" rows="5"></textarea>
                        ...
                        <div class="row" style="margin-top: 15px">
                            <div class="col-md-6">
                                ...
                                <textarea name="banner_text_uz" class="form-control" id="banner_text_uz" cols="30" rows="5"></textarea>
                            ...
                            <div class="col-md-6">
                                ...
                                <textarea name="banner_content_uz" class="form-control" id="banner_content_uz" cols="30" rows="5"></textarea>
                        ...
                        <div class="row" style="margin-top: 15px">
                            <div class="col-md-6">
                                ...
                                <textarea name="banner_text_en" class="form-control" id="banner_text_en" cols="30" rows="5"></textarea>
                            ...
                            <div class="col-md-6">
                                ...
                                <textarea name="banner_content_en" class="form-control" id="banner_content_en" cols="30" rows="5"></textarea>
