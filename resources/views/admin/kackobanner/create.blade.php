                ...
                <div class="card-body">
                        ...
                        <div class="row" style="margin-top: 15px">
                            <div class="col-md-12">
                                ...
                                <textarea name="footercontent_uz" class="my-editor" id="footercontent_uz" cols="30" rows="10"></textarea>
                                @if($errors->has('footercontent_uz'))
                                <div class="alert alert-success alert-dismissible fade show" role="alert">
                                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                        <span aria-hidden="true">&times;</span>
                                    </button>
                                    {{ $errors->first('footercontent_uz') }}
                                </div>
                                @endif
                            </div>
                        </div>
                        <div class="row" style="margin-top: 15px">
                            <div class="col-md-12">
                                ...
                                <textarea name="footercontent_ru" class="my-editor" id="footercontent_ru" cols="30" rows="10"></textarea>
                                @if($errors->has('footercontent_ru'))
                                <div class="alert alert-success alert-dismissible fade show" role="alert">
                                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                        <span aria-hidden="true">&times;</span>
                                    </button>
                                    {{ $errors->first('footercontent_ru') }}
                                </div>
                                @endif
                            </div>
                        </div>
                        ...
                        <div class="row" style="margin-top: 15px">
                            <div class="col-md-12">
                                ...
                                <textarea name="footercontent_en" class="my-editor" id="footercontent_en" cols="30" rows="10"></textarea>
                                @if($errors->has('footercontent_en'))
                                <div class="alert alert-success alert-dismissible fade show" role="alert">
                                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                        <span aria-hidden="true">&times;</span>
                                    </button>
                                    {{ $errors->first('footercontent_en') }}
                                </div>
                                @endif
                            </div>
                        </div><br><br>
