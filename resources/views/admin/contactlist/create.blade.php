...
@section('content')
    <div class="page-content-wrapper ">
        ...
        <div class="container-fluid">
            ...
            <form action="{{ route('contactlist.store') }}" enctype="multipart/form-data" method="POST">
                @csrf
                <div class="card">
                    <div class="card-body">
                            ...
                            <div class="row" style="margin-top: 15px">
                                <div class="col-md-4">
                                    ...
                                    <input type="text" id="work_days_uz" class="form-control" name="work_days_uz">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" id="work_days_ru" class="form-control" name="work_days_ru">
                                 ...
                                 <div class="col-md-4">
                                    ...
                                    <input type="text" id="work_days_en" class="form-control" name="work_days_en">
                             ...
                             <div class="row" style="margin-top: 15px">
                                <div class="col-md-4">
                                    ...
                                    <input type="text" id="opening_hours_uz" class="form-control" name="opening_hours_uz">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" id="opening_hours_ru" class="form-control" name="opening_hours_ru">
                                 ...
                                 <div class="col-md-4">
                                    ...
                                    <input type="text" id="opening_hours_en" class="form-control" name="opening_hours_en">
