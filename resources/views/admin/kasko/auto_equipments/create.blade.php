...
@section('title', 'Add Kasko Auto Equipment')
...
@section('content')
    <div class="page-content-wrapper ">
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="page-title-box">
                        <h4 class="page-title">Add Kasko Auto Equipment</h4>
                    </div>
                </div>
            ...
            <form action="{{ route('kasko_auto_equipment.store') }}" method="POST">
                @csrf
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <select name="model_id" id="model_id" class="form-control">
                                    @foreach ($models as $model)
                                        <option value="{{ $model->id }}">{{ $model->brand->name_en }} | {{ $model->name_en }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="number" id="tariff" step="0.1" max="100" class="form-control" name="tariff" required>
