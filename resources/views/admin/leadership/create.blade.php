...
<div class="page-content-wrapper ">
    ...
    <div class="container-fluid">
        ...
        <form action="{{ route('leadership.store') }}" enctype="multipart/form-data" method="POST">
            @csrf
            <div class="card">
                <div class="card-body">
                    <div class="row" style="margin-top: 15px">
                     ...
                     <div class="row" style="margin-top: 15px">
                        <div class="col-md-3">
                            ...
                            <input type="text" id="job_uz" class="form-control" name="job_uz">
                        ...
                        <div class="row" style="margin-top: 15px">
                            <div class="col-md-3">
                                ...
                                <input type="text" id="job_ru" class="form-control" name="job_ru">
